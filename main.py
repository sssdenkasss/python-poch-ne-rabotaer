...
img_back = "1920x1080.jpg"
img_hero = "rocket-removebg-preview.png"

img_bullet = 'bullet.png'
img_enemy = 'ufo.png'
img_enemy2 = 'ufo-removebg-preview.png'
score = 0
lost = 0
max_lost = 3
...
ship = Player(img_hero, 5, win_height - 100, 160, 120, 10)
finish = False
run = True
...
for i in range(1, 6):
    monster = Enemy(img_enemy2, randint(50, win_width - 80), -60, 80, 50,
                    randint(1, 5))
...
while run:
    ...
    if level2:
        if not finish:
            ...
            bullets.update()
            monsters2.update()
            text = font2.render("Рахунок2: " + str(score), True, (255, 255, 255))
            window.blit(text, (10, 20))
            text_lose = font2.render("Пропущено: " + str(lost), True, (255, 255, 255))
            window.blit(text_lose, (10, 50))
            ship.reset()
